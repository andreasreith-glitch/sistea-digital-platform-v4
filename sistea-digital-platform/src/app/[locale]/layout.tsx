      ...
      <header className="sticky top-0 z-50 border-b border-slate-200 bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex h-[84px] max-w-7xl items-center justify-between gap-5 px-5 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href={`/${locale}#contact`}
              className="hidden rounded-lg bg-cyan-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-cyan-700 lg:inline-flex"
            >
              {text.cta}
            </Link>
          </div>
      ...
      <footer className="bg-slate-950 px-6 py-12 text-white">
        <div className="mx-auto max-w-7xl">
          <img
            src="/images/sistea-logo-header.png"
            alt="SISTEA"
            className="h-14 w-auto rounded-md bg-white p-1"
          />
