...
const labels = {
  es: {
    ...
    text: "Para un cálculo rápido puedes usar una factura reciente o sumar varios meses. Para una evaluación energética más sólida, SISTEA recomienda analizar 6–12 meses consecutivos de facturas eléctricas. El resultado de esta calculadora es solo una primera referencia y no sustituye un estudio técnico ni constituye una garantía de ahorro.",
    ...
    send: "Enviar 6–12 meses de facturas eléctricas a SISTEA",
  ...
  en: {
    ...
    text: "For a quick calculation, use one recent electricity bill or aggregate several months. For a more robust energy assessment, SISTEA recommends analyzing 6–12 consecutive months of electricity bills. This calculator provides an initial reference only and does not replace an engineering study or guarantee savings.",
    ...
    send: "Send 6–12 months of electricity bills to SISTEA",
  ...
  de: {
    ...
    text: "Für eine schnelle Berechnung kannst du eine aktuelle Stromrechnung verwenden oder mehrere Monate zusammenfassen. Für eine belastbarere Energieanalyse empfiehlt SISTEA die Auswertung von 6–12 aufeinanderfolgenden Monaten Stromrechnungen. Das Ergebnis dieser Berechnung ist nur eine erste Orientierung und ersetzt keine technische Studie. Es stellt keine Einspargarantie dar.",
    ...
    send: "6–12 Monate Stromrechnungen an SISTEA senden",
